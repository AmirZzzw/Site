...
function openPaymentPage(productName, price) {
  ...
  paymentPage.document.write(`
    ...
    <head>
      ...
      <style>
        html, body {
          margin: 0; padding: 0; height: 100%; font-family: 'Vazir', sans-serif; overflow: hidden; color: white;
          background: black;
        }
        #tsparticles {
          position: fixed;
      ...
      <script>
        tsParticles.load("tsparticles", {
          particles: {
            ...
            shadows: { // tsParticles native shadow doesn't exist but we use "shadow" plugin
              enable: true,
