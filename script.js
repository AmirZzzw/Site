...
function openFeaturesPage() {
  ...
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/gh/rastikerdar/vazir-font@v30.1.0/dist/font-face.css" rel="stylesheet">
    <style>
      body{font-family:Vazir;background:#1c1c1c;color:white;text-align:center;margin:0}
      .container{max-width:700px;margin:30px auto;padding:25px;background:rgba(255,255,255,.05);border-radius:20px;backdrop-filter:blur(15px)}
      ...
      button{margin-top:20px;padding:10px 30px;font-size:16px;border:none;border-radius:50px;background:#ff9800;cursor:pointer;}
