...
const FETCH_TIMEOUT = 15000; // 15 ثانیه
        ...
        sendBtn.onclick = function() {
          ...
          .then(function(data) {
            ...
            if (data.ok) {
              ...
              throw new Error(data.description || "خطای نامشخص از سمت سرور");
            }
          })
          .catch(function(error) {
            ...
            if (error.name === 'AbortError') {
              statusDiv.innerText = "⏰ زمان درخواست طولانی شد (بیش از ${FETCH_TIMEOUT/1000} ثانیه). لطفاً اینترنت خود را بررسی و دوباره تلاش کنید.";
            } else {
